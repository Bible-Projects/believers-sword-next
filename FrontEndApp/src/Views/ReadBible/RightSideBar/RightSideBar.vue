    ...
    <div class="h-full w-full flex">
        ...
        <div class="w-40px min-w-40px bg-gray-100 dark:bg-dark-800 flex flex-col items-center gap-1 pt-3 text-size-20px">
            <div
                ...
                class="w-27px hover:bg-orange-500 !dark:hover:bg-[var(--primary-color-light)] dark:hover:bg-opacity-25 !dark:hover:text-white hover:dark:text-black hover:bg-opacity-20 flex items-center justify-center py-1 rounded-md cursor-pointer"
                :class="{ 'bg-[var(--primary-color)] !text-black !hover:bg-[var(--primary-color)]': selectedButton == menu.key }"
